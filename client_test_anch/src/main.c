...
void register_screen(GtkWidget *widget, GdkEventButton *event, gpointer **activity_bl) {
    ...
    //gtk_widget_set_size_request(GTK_WIDGET(main_data.reg_box), 10, 10);
    ...
    gtk_box_pack_start(GTK_BOX(main_data.reg_box), logo_box, FALSE, FALSE, 10);
...
void start_screen(GtkWidget **activity_block) {
    ...
    gtk_widget_set_size_request(GTK_WIDGET(main_data.login_box), 380, 530);
